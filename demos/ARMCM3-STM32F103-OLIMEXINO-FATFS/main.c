...
//static SPIConfig hs_spicfg = {NULL, IOPORT2, GPIOD_MMC_CS, 0};

/* Low speed SPI configuration (281.250kHz, CPHA=0, CPOL=0, MSb first).*/
static SPIConfig ls_spicfg = {NULL, IOPORT2, GPIOB_SPI2NSS,
                              SPI_CR1_BR_2 | SPI_CR1_BR_1};
//static SPIConfig ls_spicfg = {NULL, IOPORT2, GPIOD_MMC_CS,
//                              SPI_CR1_BR_2 | SPI_CR1_BR_1};
...
static msg_t Thread1(void *arg) {
  ...
  while (TRUE) {
    palTogglePad(IOPORT1, GPIOA_LED);
    if (fs_ready)
...
int main(void) {
  ...
  //palSetPadMode(IOPORT4, GPIOD_MMC_CS, PAL_MODE_OUTPUT_PUSHPULL);
  //palSetPad(IOPORT4, GPIOD_MMC_CS);
  mmcObjectInit(&MMCD1);
